...
-clear upward trend
-no cyclicity
-there is seasonality (e.g. highest in december, lowest in february)
...
Your answer:#
-highest in december (more extreme in 1992/1993 compared to other years)
-mostly increasing throughout the year
...
Your answer:
-highest in january
-lowest in feburary (exception in 2008, shifted by 1 month)
...
Your answer:
-lowest in february  (exception in 2008, shifted by 2 month)
-highest in jan/dec
...
Your answer:
  ...
  + Seasonality evident in all plots
  + Cyclicity (about 10 years) starting 1975
  + upwards trend until 1980
...
Your answer:
first 3 lags show statistically relevant data, remaining is similar to white noise
